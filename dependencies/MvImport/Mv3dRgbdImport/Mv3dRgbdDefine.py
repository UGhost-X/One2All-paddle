...
MV3D_RGBD_BOOL_EMPTY_POINT              = "SDKEmptyPoint"					   #~chinese 计算点云空点（默认值true：计算空点；false：不计算空点） ~english Calculate empty point of point cloud: true (calculate empty point), false (don't calculate empty point)
MV3D_RGBD_ENUM_NORMALS_CALC_MODE        = "SDKNormalsCalcMode"                 #~chinese 法向量计算模式（默认值：快速模式），详见Mv3dRgbdNormalsCalcMode
                                                                               #~english Normals caclulate mode. Default is fast mode. Refer to Mv3dRgbdNormalsCalcMode
MV3D_RGBD_BOOL_JPEG_RECT                = "SDKJpegRect"                        #~chinese SDKJpeg矫正使能（默认值false）    ~english SDK to jpeg image correction. Default is false  
...
FileType_HIBAG                          = 4                                    #~chinese HIBAG格式                     ~english HIBAG
...
# Mv3dRgbdNormalsCalcMode
# ch:法向量计算模式 | en:Normals Calculate Mode
NormalsCalcMode_Fast                    = 1                                    #~chinese 快速模式                      ~english Fast mode
NormalsCalcMode_Precise                 = 2                                    #~chinese 精确模式                      ~english Precise mode
...
_MV3D_RGBD_CONVERT_COLOR_PAPRAM_._fields_ = [ 
    ...
    ('nInvalidValueNum',c_uint),                                               #~chinese 无效值数量                    ~english The number of invalid values
...
_MV3D_RGBD_PARAM_._fields_=[
    ('enParamType', Mv3dRgbdParamType),                                        #~chinese 参数类型                      ~english Param type
    ('ParamInfo', MV3D_RGBD_PARAM_ParamInfo),                                  #~chinese 参数信息                      ~english Param info
    ('nReserved', c_byte*16),                                                  #~chinese 保留字节                      ~english Reserved
]
...
# ch:实例分割矩形信息 | en:Instance Segmentation Box Information
class _MV3D_RGBD_BOX_F_(Structure):
    pass
_MV3D_RGBD_BOX_F_._fields_=[
    ('fCenterX',c_float),                                                      #~chinese 中心点列坐标                  ~english X-coordinate of center point
    ('fCenterY',c_float),                                                      #~chinese 中心点行坐标                  ~english Y-coordinate of center point
    ('fWidth',c_float),                                                        #~chinese 矩形宽度(长半轴)              ~english Rectangle width (major axis)
    ('fHeight',c_float),                                                       #~chinese 矩形高度(短半轴)              ~english Rectangle height (minor axis)
    ('fAngle',c_float),                                                        #~chinese 矩形角度                      ~english Rectangle angle
]
MV3D_RGBD_BOX_F = _MV3D_RGBD_BOX_F_

# ch:实例分割坐标信息 | en:Instance Segmentation Coordinate Information
class _MV3D_RGBD_POINT_I_(Structure):
    pass
_MV3D_RGBD_POINT_I_._fields_=[
    ('nX',c_int),                                                              #~chinese X坐标                         ~english X-coordinate
    ('nX',c_int),                                                              #~chinese Y坐标                         ~english Y-coordinate 
]
MV3D_RGBD_POINT_I = _MV3D_RGBD_POINT_I_

# ch:实例分割顶点信息 | en:Instance Segmentation Vertex Information
class _MV3D_RGBD_INSTANCE_SEG_OBJ_POLYGON_(Structure):
    pass
_MV3D_RGBD_INSTANCE_SEG_OBJ_POLYGON_._fields_=[
    ('nVertexNum',c_int),                                                      #~chinese 顶点数                        ~english The number of vertexes
    ('stPoint',MV3D_RGBD_POINT_I * 16),                                        #~chinese 顶点                          ~english Vertexes
]
MV3D_RGBD_INSTANCE_SEG_OBJ_POLYGON = _MV3D_RGBD_INSTANCE_SEG_OBJ_POLYGON_

# ch:实例分割对象信息 | en:Instance Segmentation Object Information
class _MV3D_RGBD_INSTANCE_SEG_OBJ_INFO_(Structure):
    pass
_MV3D_RGBD_INSTANCE_SEG_OBJ_INFO_._fields_=[
    ('nClsLabel',c_int),                                                       #~chinese 类别值                        ~english Class value
    ('nMaskPixel',c_int),                                                      #~chinese 掩膜对应的像素值               ~english Pixel value corresponding to the mask
    ('nArea',c_int),                                                           #~chinese 掩膜面积                      ~english Mask area
    ('fConfidence',c_float),                                                   #~chinese 置信度                        ~english Confidence coefficient
    ('stObjBox',MV3D_RGBD_BOX_F),                                              #~chinese 目标框                        ~english Object box 
    ('chLabelName',c_byte * 128),                                              #~chinese 标签名称                      ~english Lable name
    ('stPolygon',MV3D_RGBD_INSTANCE_SEG_OBJ_POLYGON),                          #~chinese 多边形                        ~english Polygon
]
MV3D_RGBD_INSTANCE_SEG_OBJ_INFO = _MV3D_RGBD_INSTANCE_SEG_OBJ_INFO_

# ch:实例分割信息 | en:Instance Segmentation Information
class _MV3D_RGBD_INSTANCE_SEG_INFO_(Structure):
    pass
_MV3D_RGBD_INSTANCE_SEG_INFO_._fields_=[
    ('nVersion',c_int),                                                        #~chinese 版本号                        ~english Version number
    ('nDataLen',c_int),                                                        #~chinese 数据长度                      ~english Data length
    ('nReserved',c_int * 16),                                                  #~chinese 保留字节                      ~english Reserved
    ('nObjNum',c_int),                                                         #~chinese 检测个数                      ~english The number of object
    ('pstObjInfo',POINTER(MV3D_RGBD_INSTANCE_SEG_OBJ_INFO)),                   #~chinese 实例分割对象信息               ~english Instance segmentation object information
]
MV3D_RGBD_INSTANCE_SEG_INFO = _MV3D_RGBD_INSTANCE_SEG_INFO_

# ch:坐标信息 | en:Coordinate Information
class _MV3D_RGBD_POINT_F_(Structure):
    pass
_MV3D_RGBD_POINT_F_._fields_=[
    ('x',c_float),                                                             #~chinese X坐标                         ~english X-coordinate
    ('y',c_float),                                                             #~chinese Y坐标                         ~english Y-coordinate
]
MV3D_RGBD_POINT_F = _MV3D_RGBD_POINT_F_

# ch:空间点信息 | en:Space Point Information
class _MV3D_RGBD_POINT_XYZ_F32_(Structure):
    pass
_MV3D_RGBD_POINT_XYZ_F32_._fields_=[
    ('x',c_float),                                                             #~chinese 空间X坐标                     ~english Space X-coordinate
    ('y',c_float),                                                             #~chinese 空间Y坐标                     ~english Space Y-coordinate
    ('z',c_float),                                                             #~chinese 空间Z坐标                     ~english Space Z-coordinate
]
MV3D_RGBD_POINT_XYZ_F32 = _MV3D_RGBD_POINT_XYZ_F32_

# ch:单件分离辅助信息 | en:Package Singulate Assisit Information
class _MV3D_RGBD_PKGTK_SINGULATE_PKG3D_ASSISIT_INFO_(Structure):
    pass
_MV3D_RGBD_PKGTK_SINGULATE_PKG3D_ASSISIT_INFO_._fields_=[
    ('stRgbRectVertexes',MV3D_RGBD_POINT_F * 4),                               #~chinese rgb图像中矩形框顶点坐标(接目标检测)              ~english Vertexes coordinates of a rectangle box in an rgb image (after object detection)
    ('stRgbConvexVertexes',MV3D_RGBD_POINT_F * 16),                            #~chinese rgb图像中凸包集顶点坐标(接实例分割)              ~english Convex vertexes coordinates in an rgb image (after instance segmentation)
    ('fContRectRatio',c_float),                                                #~chinese 轮廓与矩形框的面积比例(除双灰度仪专用)            ~english The ratio of the profile to the area of the rectangle
    ('nOverLapPkgNum',c_int),                                                  #~chinese 叠件数量(1或者2)              ~english The number of overlap package
    ('nObjLabel',c_int),                                                       #~chinese 目标类别                      ~english Object class
]
MV3D_RGBD_PKGTK_SINGULATE_PKG3D_ASSISIT_INFO = _MV3D_RGBD_PKGTK_SINGULATE_PKG3D_ASSISIT_INFO_

# ch:单件分离矩形信息 | en:Package Singulate Box Information
class _MV3D_RGBD_PKGTK_SINGULATE_PKG3D_(Structure):
    pass
_MV3D_RGBD_PKGTK_SINGULATE_PKG3D_._fields_=[
    ('stRectVertexes',MV3D_RGBD_POINT_XYZ_F32 * 4),                            #~chinese 矩形框顶点坐标(接目标检测)     ~english Rectangle vertex coordinates (after object detection)
    ('stConvexVertexes',MV3D_RGBD_POINT_XYZ_F32 * 16),                         #~chinese 凸包集顶点坐标(接实例分割)     ~english Convex vertexes coordinates (after instance segmentation)
    ('nConvexPtsNum',c_int),                                                   #~chinese 凸包集顶点数目                ~english The number of convex vertexes
    ('nFlagRect',c_int),                                                       #~chinese 矩形框顶点坐标是否有效(HKA_FALSE: 无效, HKA_TRUE: 有效)
                                                                               #~english Whether the rectangle vertex coordinates are valid (HKA_FALSE: invalid, HKA_TRUE: valid)
    ('nFlagConvex',c_int),                                                     #~chinese 凸包集顶点坐标是否有效(HKA_FALSE: 无效, HKA_TRUE: 有效)
                                                                               #~english Whether the convex vertex coordinates are valid (HKA_FALSE: invalid, HKA_TRUE: valid)
]
MV3D_RGBD_PKGTK_SINGULATE_PKG3D = _MV3D_RGBD_PKGTK_SINGULATE_PKG3D_

# ch:单件分离包裹信息 | en:Package Singulate Package Information
class _MV3D_RGBD_SINGULATE_EDP_CALPOSE_(Structure):
    pass
_MV3D_RGBD_SINGULATE_EDP_CALPOSE_._fields_=[
    ('nPkgId',c_int),                                                          #~chinese 包裹ID号                      ~english Package ID
    ('stPkgs3d',MV3D_RGBD_PKGTK_SINGULATE_PKG3D),                              #~chinese 包裹信息                      ~english Package information
    ('stAssistInfo',MV3D_RGBD_PKGTK_SINGULATE_PKG3D_ASSISIT_INFO),             #~chinese 辅助信息                      ~english Assist information
]
MV3D_RGBD_SINGULATE_EDP_CALPOSE = _MV3D_RGBD_SINGULATE_EDP_CALPOSE_

# ch:单件分离报文信息 | en:Package Singulate Message Information
class _MV3D_RGBD_SINGULATE_PKG_INFO_(Structure):
    pass
_MV3D_RGBD_SINGULATE_PKG_INFO_._fields_=[
    ('nVer',c_int),                                                            #~chinese 版本号(当前为0x0100 )         ~english Version number (current version: 0x0100)
    ('nFrameId',c_int),                                                        #~chinese 帧号                          ~english Frame ID
    ('chEdpMsg',c_ubyte * 1024),                                               #~chinese EDP报文内容(单件分离下无效)    ~english Message content of EDP (invalid in package singulate)
    ('nPkgsNum',c_int),                                                        #~chinese 包裹数量                      ~english The number of package
    ('pstPkgEdpInfo',POINTER(MV3D_RGBD_SINGULATE_EDP_CALPOSE)),                #~chinese 包裹信息集合(根据实际包裹数量分配内存)
                                                                               #~english Package information (memory is allocated based on the actual number of packages)
]
MV3D_RGBD_SINGULATE_PKG_INFO = _MV3D_RGBD_SINGULATE_PKG_INFO_

# ch:吸嘴位置信息 | en:Grasp Gripper Pose Information
class _MV3D_RGBD_GRASP_GRIPPER_POS_INFO_(Structure):
    pass
_MV3D_RGBD_GRASP_GRIPPER_POS_INFO_._fields_=[
    ('stGripperRect',MV3D_RGBD_POINT_F * 4),                                   #~chinese 抓取的矩形框                  ~english Grasp rectangle
    ('nReserved',c_int * 16),                                                  #~chinese 保留字节                      ~english Reserved
]
MV3D_RGBD_GRASP_GRIPPER_POS_INFO = _MV3D_RGBD_GRASP_GRIPPER_POS_INFO_

# ch:机械臂包裹抓取位姿信息--辅助信息 | en:Package Grasp Pose Information of The Robotic Arm -- Assist Information
class _MV3D_RGBD_GRASP_ROBOT_CAP_INFO_ASSIST_(Structure):
    pass
_MV3D_RGBD_GRASP_ROBOT_CAP_INFO_ASSIST_._fields_=[
    ('fPkgHeight',c_float),                                                    #~chinese 包裹高度                      ~english Package height
    ('nFlagGripperNum',c_int),                                                 #~chinese 抓取使用执行器数量            ~english The number of actuators used to grab
    ('stGripperPos',MV3D_RGBD_GRASP_GRIPPER_POS_INFO * 2),                     #~chinese 执行器位置                    ~english Actuators position
    ('nSegClassId',c_int),                                                     #~chinese 分割ID号                      ~english Segmentation class id
    ('nFlagPkgType',c_int),                                                    #~chinese 包裹类型标志位                ~english Package type flag
    ('fEliminatePackageRatio',c_float),                                        #~chinese 包裹类型标志位                ~english Package type flag
    ('nPointAddrOffset',c_int),                                                #~chinese 剔除区域包裹面积比例          ~english Eliminate package ratio
    ('nPointNum',c_int),                                                       #~chinese 点云相对地址                  ~english Point cloud offset address
    ('nReserved',c_int * 13),                                                  #~chinese 点云数量                      ~english The number of point could
]
MV3D_RGBD_GRASP_ROBOT_CAP_INFO_ASSIST = _MV3D_RGBD_GRASP_ROBOT_CAP_INFO_ASSIST_

# ch:机械臂包裹抓取位姿信息--图像信息 | en:Package Grasp Pose Information of The Robotic Arm -- Image Information
class _MV3D_RGBD_GRASP_ROBOT_CAP_INFO_IMG_(Structure):
    pass
_MV3D_RGBD_GRASP_ROBOT_CAP_INFO_IMG_._fields_=[
    ('stPkgPtRgb',MV3D_RGBD_POINT_F),                                          #~chinese rgb图像上的抓取点坐标         ~english Grasp point coordinate in rgb image
    ('stPkgRectRgb',MV3D_RGBD_POINT_F * 4),                                    #~chinese rgb图像上的抓取面坐标         ~english Grasping surface coordinates in rgb image
    ('stPkgCvxRgb',MV3D_RGBD_POINT_F * 16),                                    #~chinese rgb图像上的凸包点             ~english Convex vertexes in rgb image
    ('nChPntNum',c_int),                                                       #~chinese 凸包点数                      ~english The number of convex vertexes
    ('nReserved',c_int * 16),                                                  #~chinese 保留字节                      ~english Reserved
]
MV3D_RGBD_GRASP_ROBOT_CAP_INFO_IMG = _MV3D_RGBD_GRASP_ROBOT_CAP_INFO_IMG_

# ch:机械臂抓取位姿 | en:Grab Position of Robotic Arm
class _MV3D_RGBD_3D_POS_F32_(Structure):
    pass
_MV3D_RGBD_3D_POS_F32_._fields_=[
    ('fX',c_float),                                                            #~chinese 空间X坐标                     ~english Space X-coordinate
    ('fY',c_float),                                                            #~chinese 空间Y坐标                     ~english Space Y-coordinate
    ('fZ',c_float),                                                            #~chinese 空间Z坐标                     ~english Space Z-coordinate
    ('fRz',c_float),                                                           #~chinese 绕Z轴旋转角度                 ~english Rotation angle about the Z axis
    ('fRy',c_float),                                                           #~chinese 绕Y轴旋转角度                 ~english Rotation angle about the Y axis
    ('fRx',c_float),                                                           #~chinese 绕X轴旋转角度                 ~english Rotation angle about the X axis
]
MV3D_RGBD_3D_POS_F32 = _MV3D_RGBD_3D_POS_F32_

# ch:机械臂包裹抓取位姿信息 | en:Package Grasp Pose Information of The Robotic Arm -- Physical Information
class _MV3D_RGBD_GRASP_ROBOT_CAP_INFO_WORLD_(Structure):
    pass
_MV3D_RGBD_GRASP_ROBOT_CAP_INFO_WORLD_._fields_=[
    ('stPkgPosRobot',MV3D_RGBD_3D_POS_F32),                                    #~chinese 机器人坐标系下的抓取位姿       ~english Grasp pose in robot coordinate system
    ('stPkgRectRobot',MV3D_RGBD_POINT_XYZ_F32 * 4),                            #~chinese 机器人坐标系下的抓取面坐标     ~english Grasping surface coordinates in robot coordinate system  
    ('stPkgCvxRobot',MV3D_RGBD_POINT_XYZ_F32 * 16),                            #~chinese 机器人坐标系下的凸包点         ~english Convex vertexes in robot coordinate system
    ('nChPntNum',c_int),                                                       #~chinese 凸包点数                      ~english The number of convex vertexes
    ('nReserved',c_int * 16),                                                  #~chinese 保留字节                      ~english Reserved
]
MV3D_RGBD_GRASP_ROBOT_CAP_INFO_WORLD = _MV3D_RGBD_GRASP_ROBOT_CAP_INFO_WORLD_

# ch:机器人坐标系下包裹抓取位姿信息 | en:Package Grasp Pose Information in Robot Coordinate System
class _MV3D_RGBD_GRASP_ROBOT_CAP_INFO_(Structure):
    pass
_MV3D_RGBD_GRASP_ROBOT_CAP_INFO_._fields_=[
    ('stPkgPosRobot',MV3D_RGBD_GRASP_ROBOT_CAP_INFO_WORLD),                    #~chinese 物理位姿信息                  ~english Physical information of pose
    ('stPkgPosImg',MV3D_RGBD_GRASP_ROBOT_CAP_INFO_IMG),                        #~chinese 图像位姿信息                  ~english Image information of pose
    ('stAssistInfo',MV3D_RGBD_GRASP_ROBOT_CAP_INFO_ASSIST),                    #~chinese 辅助信息                      ~english Assist Information
]
MV3D_RGBD_GRASP_ROBOT_CAP_INFO = _MV3D_RGBD_GRASP_ROBOT_CAP_INFO_

# ch:3D坐标点(S16) | en:3D Coordinate Point (S16)
class _MV3D_RGBD_3DPOINT_16_(Structure):
    pass
_MV3D_RGBD_3DPOINT_16_._fields_=[
    ('nX',int16_t),                                                            #~chinese 空间X坐标                     ~english Space X-coordinate
    ('nY',int16_t),                                                            #~chinese 空间Y坐标                     ~english Space Y-coordinate
    ('nZ',int16_t),                                                            #~chinese 空间Z坐标                     ~english Space Z-coordinate
    ('nReserved',uint16_t),                                                    #~chinese 保留字节                      ~english Reserved
]
MV3D_RGBD_3DPOINT_16 = _MV3D_RGBD_3DPOINT_16_

# ch:rgb相机下抓取位姿信息--辅助信息  | en:Grasp Pose Information in Rgb Camera -- Assist Information
class _MV3D_RGBD_GRASP_CAM_CAP_INFO_ASSIST_(Structure):
    pass
_MV3D_RGBD_GRASP_CAM_CAP_INFO_ASSIST_._fields_=[
    ('fCapLength',c_float),                                                    #~chinese 类的抓取长度                  ~english Class capture length
    ('fCapWidth',c_float),                                                     #~chinese 类的抓取宽度                  ~english Class capture width
    ('fCapAreaRatio',c_float),                                                 #~chinese 抓取面积比例                  ~english Capture area ratio
    ('nSegClassId',c_int),                                                     #~chinese 分割ID号                      ~english Segmentation class id
    ('nDetectRoiId',c_int),                                                    #~chinese 检测区域号                    ~english Detect roi id
    ('nReserved',c_int * 16),                                                  #~chinese 保留字节                      ~english Reserved
]
MV3D_RGBD_GRASP_CAM_CAP_INFO_ASSIST = _MV3D_RGBD_GRASP_CAM_CAP_INFO_ASSIST_

# ch:rgb相机下抓取位姿信息--图像信息  | en:Grasp Pose Information in Rgb Camera -- Image Information
class _MV3D_RGBD_GRASP_CAM_CAP_INFO_IMG_(Structure):
    pass
_MV3D_RGBD_GRASP_CAM_CAP_INFO_IMG_._fields_=[
    ('stRgbImgCenterPt',MV3D_RGBD_POINT_F),                                    #~chinese rgb相机下的图像中心点         ~english Image center point in rgb camera
    ('stRgbImgGraspPt',MV3D_RGBD_POINT_F),                                     #~chinese rgb相机下的图像抓取点         ~english Image grasp point in rgb camera
    ('stRgbImgCvxHull',MV3D_RGBD_POINT_F * 16),                                #~chinese rgb相机下的图像凸包           ~english Image convex vertexes in rgb camera
    ('nChPntNum',c_int),                                                       #~chinese 凸包点数                      ~english The number of convex vertexes
    ('nReserved',c_int * 16),                                                  #~chinese 保留字节                      ~english Reserved
]
MV3D_RGBD_GRASP_CAM_CAP_INFO_IMG = _MV3D_RGBD_GRASP_CAM_CAP_INFO_IMG_

# ch:rgb相机下抓取位姿信息--物理信息 | en:Grasp Pose Information in Rgb Camera -- Physical Information
class _MV3D_RGBD_GRASP_CAM_CAP_INFO_WORLD_(Structure):
    pass
_MV3D_RGBD_GRASP_CAM_CAP_INFO_WORLD_._fields_=[
    ('stRgbCamCenterPt',MV3D_RGBD_POINT_XYZ_F32),                              #~chinese rgb相机下的空间中心点         ~english Space center point in rgb camera
    ('stRgbCamGraspPt',MV3D_RGBD_POINT_XYZ_F32),                               #~chinese rgb相机下的空间抓取点         ~english Space grasp point in rgb camera
    ('stRgbCamCvxHull',MV3D_RGBD_POINT_XYZ_F32 * 16),                          #~chinese rgb相机下的空间凸包           ~english Space convex vertexes in rgb camera
    ('nChPntNum',c_int),                                                       #~chinese 凸包点数                      ~english The number of convex vertexes
    ('nRgbCamNormal',c_int * 3),                                               #~chinese rgb相机下的法向量             ~english Normal vector in rgb camera
    ('nReserved',c_int * 16),                                                  #~chinese 保留字节                      ~english Reserved
]
MV3D_RGBD_GRASP_CAM_CAP_INFO_WORLD = _MV3D_RGBD_GRASP_CAM_CAP_INFO_WORLD_

# ch:rgb相机下位姿信息 | en:Pose Information in Rgb Camera
class _MV3D_RGBD_GRASP_CAM_CAP_POS_INFO_(Structure):
    pass
_MV3D_RGBD_GRASP_CAM_CAP_POS_INFO_._fields_=[
    ('stPkgPosCam',MV3D_RGBD_GRASP_CAM_CAP_INFO_WORLD),                        #~chinese 物理位姿信息                  ~english Physical information of pose
    ('stPkgPosImg',MV3D_RGBD_GRASP_CAM_CAP_INFO_IMG),                          #~chinese 图像位姿信息                  ~english Image information of pose
    ('stAssistInfo',MV3D_RGBD_GRASP_CAM_CAP_INFO_ASSIST),                      #~chinese 辅助信息                      ~english Assist information
]
MV3D_RGBD_GRASP_CAM_CAP_POS_INFO = _MV3D_RGBD_GRASP_CAM_CAP_POS_INFO_

# ch:抓取信息 | en:Grasp Information
class _MV3D_RGBD_GRASP_INFO_(Structure):
    pass
_MV3D_RGBD_GRASP_INFO_._fields_=[
    ('nGraspVer',c_int),                                                       #~chinese 抓取版本号(当前抓取chunk data版本为V1.1)          ~english Grasp version (Current grasp chunk data version: V1.1)
    ('nFrmId',c_int),                                                          #~chinese 帧号                          ~english Frame number
    ('nValidFlag',c_int),                                                      #~chinese 抓取信息是否有效              ~english Whether the grasp information is valid
    ('nTriggerId',c_int),                                                      #~chinese 触发ID                        ~english Trigger ID
    ('nRobotPkgPosNum',c_int),                                                 #~chinese 机器人坐标系下包裹抓取位姿数目                    ~english The number of package grasp poses in robot coordinate system
    ('nNoCapPosNum',c_int),                                                    #~chinese 机器人坐标系下包裹不可抓取位姿数目                ~english The number of poses that the package cannot be captured in robot coordinate system
    ('nCameraPkgPosNum',c_int),                                                #~chinese 相机坐标系下包裹抓取位姿数目                      ~english The number of package grasp poses in camera coordinate system
    ('nRobotPkgPointNum',c_int),                                               #~chinese 机器人坐标系下包裹点云数                          ~english The number of package point cloud in robot coordinate system
    ('nReserved',c_int * 64),                                                  #~chinese 保留字节                      ~english Reserved
    ('pstRobotPkgPos',POINTER(MV3D_RGBD_GRASP_ROBOT_CAP_INFO)),                #~chinese 机器人坐标系下包裹抓取位姿信息(n = robot_pkg_pos_num，数据量为robot_pkg_pos_num * sizeof(MV3D_RGBD_GRASP_ROBOT_CAP_INFO))
                                                                               #~english Package grasp poses information in robot coordinate system (n = robot_pkg_pos_num, data length = robot_pkg_pos_num * sizeof(MV3D_RGBD_GRASP_ROBOT_CAP_INFO))
    ('pstNoCapPos',POINTER(MV3D_RGBD_GRASP_ROBOT_CAP_INFO)),                   #~chinese 机器人坐标系下包裹不可抓取位姿信息(包裹不可抓取位姿信息数组大小动态变动，实际大小由no_cap_pos_num具体定)
                                                                               #~english The information of poses that the package cannot grab in robot coordinate system (the size of the array varies dynamically, and the actual size is determined by no_cap_pos_num)
    ('pstCameraCapPos',POINTER(MV3D_RGBD_GRASP_CAM_CAP_POS_INFO)),             #~chinese 相机坐标系下包裹抓取位姿信息(m = camera_pkg_pos_num，数据量为camera_pkg_pos_num * sizeof(MV3D_RGBD_GRASP_CAM_CAP_POS_INFO))
                                                                               #~english The information of package grasp poses in camera coordinate system (m = camera_pkg_pos_num, data length = camera_pkg_pos_num * sizeof(MV3D_RGBD_GRASP_CAM_CAP_POS_INFO))
    ('pstRobotPkgPoints',POINTER(MV3D_RGBD_3DPOINT_16)),                       #~chinese 所有可抓取包裹的点云信息(点云数量组大小动态变动，实际大小由robot_pkg_point_num定)
                                                                               #~english All ponit cloud information related to the package can be captured (the size of the array varies dynamically, and the actual size is determined by robot_pkg_point_num)
]
MV3D_RGBD_GRASP_INFO = _MV3D_RGBD_GRASP_INFO_

# ch:IMU数据 | en:IMU Data
class _MV3D_RGBD_IMU_DATA_(Structure):
    pass
_MV3D_RGBD_IMU_DATA_._fields_=[
    ('nVersion',c_int),                                                        #~chinese 版本号(当前版本为0x0100)       ~english Version number (current version: 0x0100)
    ('fXAccSpeed',c_float),                                                    #~chinese X方向加速度                   ~english Acceleration in X direction
    ('fYAccSpeed',c_float),                                                    #~chinese Y方向加速度                   ~english Acceleration in Y direction
    ('fZAccSpeed',c_float),                                                    #~chinese Z方向加速度                   ~english Acceleration in Z direction
    ('fXAngSpeed',c_float),                                                    #~chinese X方向角速度                   ~english Angular velocity in the X direction
    ('fYAngSpeed',c_float),                                                    #~chinese Y方向角速度                   ~english Angular velocity in the Y direction
    ('fZAngSpeed',c_float),                                                    #~chinese Z方向角速度                   ~english Angular velocity in the Z direction
    ('nflag',c_int),                                                           #~chinese 校准标志位(未校准:0,校准:1,默认为0)           ~english Calibration flag (uncalibrated: 0, calibrated: 1, Default: 0)
    ('nReserved',c_uint * 32),                                                 #~chinese 保留字节                      ~english Reserved
]
MV3D_RGBD_IMU_DATA = _MV3D_RGBD_IMU_DATA_
...
__all__ = ['_MV3D_RGBD_VERSION_INFO_','MV3D_RGBD_VERSION_INFO','_MV3D_RGBD_DEVICE_NET_INFO_','MV3D_RGBD_DEVICE_NET_INFO','_MV3D_RGBD_DEVICE_USB_INFO_','MV3D_RGBD_DEVICE_USB_INFO', 
           ...
           '_MV3D_RGBD_CONVERT_COLOR_PAPRAM_', 'MV3D_RGBD_CONVERT_COLOR_PAPRAM','_MV3D_RGBD_IMU_DATA_','MV3D_RGBD_IMU_DATA',
           '_MV3D_RGBD_INSTANCE_SEG_INFO_', 'MV3D_RGBD_INSTANCE_SEG_INFO', '_MV3D_RGBD_INSTANCE_SEG_OBJ_INFO_', 'MV3D_RGBD_INSTANCE_SEG_OBJ_INFO',
           '_MV3D_RGBD_INSTANCE_SEG_OBJ_POLYGON_', 'MV3D_RGBD_INSTANCE_SEG_OBJ_POLYGON', '_MV3D_RGBD_POINT_I_', 'MV3D_RGBD_POINT_I', '_MV3D_RGBD_BOX_F_', 'MV3D_RGBD_BOX_F',
           '_MV3D_RGBD_SINGULATE_PKG_INFO_', 'MV3D_RGBD_SINGULATE_PKG_INFO', '_MV3D_RGBD_SINGULATE_EDP_CALPOSE_', 'MV3D_RGBD_SINGULATE_EDP_CALPOSE',
           '_MV3D_RGBD_PKGTK_SINGULATE_PKG3D_', 'MV3D_RGBD_PKGTK_SINGULATE_PKG3D', '_MV3D_RGBD_PKGTK_SINGULATE_PKG3D_ASSISIT_INFO_', 'MV3D_RGBD_PKGTK_SINGULATE_PKG3D_ASSISIT_INFO',
           '_MV3D_RGBD_POINT_XYZ_F32_', 'MV3D_RGBD_POINT_XYZ_F32', '_MV3D_RGBD_POINT_F_', 'MV3D_RGBD_POINT_F', '_MV3D_RGBD_GRASP_INFO_', 'MV3D_RGBD_GRASP_INFO',
           '_MV3D_RGBD_GRASP_ROBOT_CAP_INFO_', 'MV3D_RGBD_GRASP_ROBOT_CAP_INFO', '_MV3D_RGBD_GRASP_ROBOT_CAP_INFO_WORLD_', 'MV3D_RGBD_GRASP_ROBOT_CAP_INFO_WORLD',
           '_MV3D_RGBD_3D_POS_F32_', 'MV3D_RGBD_3D_POS_F32', '_MV3D_RGBD_GRASP_ROBOT_CAP_INFO_IMG_', 'MV3D_RGBD_GRASP_ROBOT_CAP_INFO_IMG', 
           '_MV3D_RGBD_GRASP_ROBOT_CAP_INFO_ASSIST_', 'MV3D_RGBD_GRASP_ROBOT_CAP_INFO_ASSIST', '_MV3D_RGBD_GRASP_GRIPPER_POS_INFO_', 'MV3D_RGBD_GRASP_GRIPPER_POS_INFO',
           '_MV3D_RGBD_GRASP_CAM_CAP_POS_INFO_', 'MV3D_RGBD_GRASP_CAM_CAP_POS_INFO', '_MV3D_RGBD_GRASP_CAM_CAP_INFO_WORLD_', 'MV3D_RGBD_GRASP_CAM_CAP_INFO_WORLD',
           '_MV3D_RGBD_GRASP_CAM_CAP_INFO_IMG_', 'MV3D_RGBD_GRASP_CAM_CAP_INFO_IMG', '_MV3D_RGBD_GRASP_CAM_CAP_INFO_ASSIST_', 'MV3D_RGBD_GRASP_CAM_CAP_INFO_ASSIST', '_MV3D_RGBD_3DPOINT_16_', 'MV3D_RGBD_3DPOINT_16']