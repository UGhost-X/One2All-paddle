...
"""
推理服务 - 自动生成
Service ID: svc_1771808293_0f7c3384
Project: 2
Task UUID: 0f7c3384
Labels: ['孔洞', '轴', '螺丝']
"""
...
app = FastAPI(
    ...
    description=f"Project: 2, UUID: 0f7c3384",
    version="1.0.0"
)

MODELS: Dict[str, Any] = {}
MODEL_PATHS = {
    "孔洞": "output/2/0f7c3384/孔洞/best_model",
    "轴": "output/2/0f7c3384/轴/best_model",
    "螺丝": "output/2/0f7c3384/螺丝/best_model"
}
...
async def health_check():
    ...
    return {
        "status": "healthy",
        "service_id": "svc_1771808293_0f7c3384",
        "project_id": "2",
        "task_uuid": "0f7c3384",
...
if __name__ == "__main__":
    logger.info(f"Starting inference service on port 9380")
