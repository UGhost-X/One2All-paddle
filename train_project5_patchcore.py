#!/usr/bin/env python3
"""
PatchCore 模型训练脚本 - 项目5 (PyTorch版本)
使用 /home/software/One2All-paddle/5/train/d34c8061 数据集
"""
import sys
import os
import time
...
def main():
    base_dir = '/home/software/One2All-paddle/5/train/d34c8061'

    # 定义要训练的类别
    categories = [
        ('圆形孔洞', os.path.join(base_dir, '圆形孔洞')),
        ('矩形孔洞', os.path.join(base_dir, '矩形孔洞')),
    ]
